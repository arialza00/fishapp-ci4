...
class dataAllSeeder extends Seeder
{
    public function run()
    {
        ...
        $startTime = strtotime('1 July 2023');
        $endTime = strtotime('20 August 2023');
        ...
        for ($x = 0; $x <= 1; $x++) {
            unset($data);
            $i = $startTime; $i <= $endTime; $i = $i + 86400;
            ...
            $g = 60; //data dikirim per 60 detik
            ...
            for ($j = $d; $j <= $e; $j = $j + $g) {
                ...
                if ($j >= $randStartHourFisherman1 * 3600 and $j < $randFinishHourFisherman1 * 3600) {
                    ...
                    $epoch = $i + $j;
                    $dt = Time::createFromTimestamp($epoch); 
